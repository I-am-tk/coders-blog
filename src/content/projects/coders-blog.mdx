...
- Interactive React and Svelte components are partially hydrated on the client side using Astro client directives in the blog articles to improve the Time to Interactive of the page.
