---
title: ":has in CSS"
description: "CSS :has A Parent Selector And It Is Better Than I Ever Could Have Hoped For"
publishedAt: "Jul 02 2022"
tags: ["css"]
---

CSS `:has` A Parent Selector And It Is Better Than I Ever Could Have Hoped For
September 26, 2022
...
Calculating specificity with the `:has` selector is a bit complex compared to a normal pseudo class. If you unfamiliar with how CSS specificity is calculated check out my ultimate CSS specificity guide.
...
With every cool CSS feature you always have to consider browser support, but luckily the browser support for this new property is quite good. It may seem low considering it only has 56.2% support, but this is a bit misleading since every major browser other than Firefox has support for this feature. The reason for the low percentage is because this features just launched at the end of August 2022 in Chrome so people are still in the process of updating Chrome to the latest versions. Firefox also has this feature behind a feature flag which hopefully means it is coming to the browser very soon. In just a few months this feature should be above 90% and able to be used on pretty much every site.
